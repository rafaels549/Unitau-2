...
public function limpar() {
  Cache::forget('equipes');
}


#[Computed(cache: true, key: 'equipes')]
...
<div class="equipe flex flex-wrap mb-3  ml-[10%] gap-5 justify-start">
    
 
    @forelse($this->equipes as $equipe)
   
    <div class="max-w-sm bg-white border border-gray-200 rounded-lg mt-5 h-full  " wire:key="equipe-{{ $equipe->id }}">
