...
<main>
    ...
    <nav x-data="{ isOpen: false }" class="container mx-auto p-6 lg:flex lg:items-center lg:justify-between">
        ...
        <div>
            <a class="text-2xl font-bold text-gray-800 hover:text-gray-700 dark:text-white dark:hover:text-gray-300 lg:text-3xl" href="#">UNITAU</a>
        </div>
        ...
        <div class="lg:-px-8 flex flex-col space-y-4 lg:mt-0 lg:flex-row lg:space-y-0">
            @guest
            <a class="transform text-gray-700 transition-colors duration-300 hover:text-blue-500 dark:text-gray-200 dark:hover:text-blue-400 lg:mx-8" href="/login" wire:navigate>Login</a>
            <a class="transform text-gray-700 transition-colors duration-300 hover:text-blue-500 dark:text-gray-200 dark:hover:text-blue-400 lg:mx-8" href="/register" wire:navigate>Registrar</a>
            @endguest
        </div>
        @auth
        <a class="mt-4 block rounded-lg bg-blue-600 px-6 py-2.5 text-center font-medium capitalize leading-5 text-white hover:bg-blue-500 lg:mt-0 lg:w-auto" href="/home" wire:navigate>Home</a>
        @endauth
    </div>
    </nav>
    ...
    <div class="container mx-auto px-6 py-16 text-center">
        ...
        <img class="h-96 w-full rounded-xl object-cover lg:w-4/5" src="/img/unitauveia.webp" />
        </div>
    </div>
    </section>
